  ...
  return (
    <main className="progress-page">
      ...
      <section className="map-settings">
        ...
        <label>New cities <input type="range" min="1" max="30" step="1" value={progress.settings.newCitiesPerSession} onChange={(event) => setProgress((current) => ({ ...current, settings: { ...current.settings, newCitiesPerSession: Number(event.target.value) } }))} /> {progress.settings.newCitiesPerSession}</label>
      </section>
